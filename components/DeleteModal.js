...
const DeleteModal = ({ postType }) => {
  ...
  return (
    <>
      <p>
        Estás a punto de borrar el siguiente contenido. Una vez borrado, no se
        podrá recuperar.
      </p>
      <br />
      <p>
        Por favor, verifica que quieres borrar el fichero metiendo{" "}
        <strong style={{ fontWeight: "Bold" }}>{deleteId}</strong> en el
        siguiente campo.
      </p>
      <form method="post" onSubmit={handleSubmit}>
        <input
          ...
          value={inputValue}
        />
        <FormNotifier errors={errors} send={validating} />
